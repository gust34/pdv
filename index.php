...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('vendor/login/images/fundo1.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" method="POST" action="autenticar.php">
					...
					<div class="wrap-input100 validate-input" data-validate = "Email ou CPF">
						<input class="input100" type="text" name="usuario" placeholder="Digite seu Email" required="">
